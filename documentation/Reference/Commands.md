...
| Command | Tier | Description                                                                                                                              |
|---------|------|------------------------------------------------------------------------------------------------------------------------------------------|
| [**Check Changes**](<Commands/Check/Check Changes>) | Enterprise | Analyzes changes between migrations and the database                                                                                     |
| [**Check Code**](<Commands/Check/Check Code>) | Community | Performs [code analysis](https://documentation.red-gate.com/fd/code-analysis-275218638.html) on migrations                               |
...
| [**Check Drift**](<Commands/Check/Check Drift>) | Enterprise | Detects schema drift between the database and migrations                                                                                                                  |
| [**Check DryRun**](<Commands/Check/Check DryRun>) | Teams | Performs a dry run of migrations to preview changes                                                                                                                       |
